...
const GroupChat = ({ openModal, selectedGroup, closeChat }) => {
  ...
  useEffect(() => {
    ...
    socketRef.current = io('https://poi-back-v6at.onrender.com/group');
  ...
  const checkPendingTasks = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://poi-back-v6at.onrender.com/api/tasks/${selectedGroup.id}`);
  ...
  useEffect(() => {
    if (selectedGroup) {
      ...
      axios.get(`https://poi-back-v6at.onrender.com/api/messages/grupo/${selectedGroup.id}?userId=${loggedInUser.id}`)
        .then(response => {
  ...
  const markMessagesAsRead = (messageIds) => {
    ...
    // axios.post(`${API_URL}/api/messages/grupo/read`, {
      axios.post(`https://poi-back-v6at.onrender.com/api/messages/grupo/read`, {
      userId: loggedInUser.id,
      groupId: selectedGroup.id,
      messageIds: filteredIds
    }).catch(error => {
